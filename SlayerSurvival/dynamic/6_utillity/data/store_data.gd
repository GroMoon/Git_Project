...
func create_default_store_data():
	store_data = {
		"STORE_ITEM_HEALTH"   : {"level": "0", "max_level": 5, "used_gold": 0},
		"STORE_ITEM_SHIELD"   : {"level": "0", "max_level": 5, "used_gold": 0},
		"STORE_ITEM_RESPAWN"  : {"level": "0", "max_level": 2, "used_gold": 0},
		"STORE_ITEM_DAMAGE"   : {"level": "0", "max_level": 5, "used_gold": 0},
		"STORE_ITEM_SPEED"    : {"level": "0", "max_level": 5, "used_gold": 0},
		"STORE_ITEM_COOLDOWN" : {"level": "0", "max_level": 5, "used_gold": 0},
		"STORE_ITEM_VAMPIRE"  : {"level": "0", "max_level": 5, "used_gold": 0},
		"STORE_ITEM_GOLD_DROP": {"level": "0", "max_level": 5, "used_gold": 0},
		"STORE_ITEM_GEM_DROP" : {"level": "0", "max_level": 5, "used_gold": 0}
	}
